...
class CustardDropDown<T> extends FormField<T> {
  ...
  @override
  FormFieldState<T> createState() => _CustardDropDownState<T>();
}

class _CustardDropDownState<T> extends FormFieldState<T> {
  @override
  CustardDropDown<T> get widget => super.widget;
