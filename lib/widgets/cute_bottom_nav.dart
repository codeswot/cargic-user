...
class CuteBottomNav extends StatefulWidget {
  CuteBottomNav({
    Key key,
    this.tabs,
  ...
  @override
  _CuteBottomNavState createState() => _CuteBottomNavState();
}

class _CuteBottomNavState extends State<CuteBottomNav> {
  int selectedIndex;
  bool clickable = true;
...
class CuteNavButton extends StatefulWidget {
  final bool active;
  final bool debug;
  final double gap;
  ...
  @override
  _CuteNavButtonState createState() => _CuteNavButtonState();
}

class _CuteNavButtonState extends State<CuteNavButton> {
  @override
  Widget build(BuildContext context) {
    return Button(
          ...
          widget.active
              ? Container(
                  ...
                  decoration: BoxDecoration(
                    border: Border(
                      bottom:
                          BorderSide(color: CargicColors.brandBlue, width: 2),
                    ),
                  ),
                )
              : Container(),
